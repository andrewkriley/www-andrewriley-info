...
description: >-
  Provides a way to set nested environment variables at a global and local
  scope. It will expose variables to both the container and the docker-compose
  file.
date: 2025-03-09T14:33:50.000Z
tags:
  - docker
categories:
  - technology
image: /p/nested-var-compose/nested.png
---
...
![](/p/nested-var-compose/1and2.png)
![](/p/nested-var-compose/3and4.png)
