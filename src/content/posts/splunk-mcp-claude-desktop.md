---
title: >-
  Connecting Splunk to Claude — Token Auth, Self-Signed Certs, and the Desktop
  Gap
description: >-
  How to wire up the Splunk MCP server to both Claude Code and Claude Desktop in
  a homelab using token-based auth and mcp-remote as a TLS proxy.
date: 2026-03-22T08:27:53.000Z
tags:
  - splunk
  - claude
  - mcp
