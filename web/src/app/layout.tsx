...
export const metadata: Metadata = {
  title: {
    default: "Andrew Riley",
    template: "%s · Andrew Riley",
  },
  description:
    "Technical leader, builder, and curious experimenter — projects, writing, and things I build and learn.",
  metadataBase: new URL("https://www.andrewriley.info"),
};
